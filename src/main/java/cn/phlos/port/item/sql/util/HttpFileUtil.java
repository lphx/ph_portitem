...
public class HttpFileUtil {
     ...
     * @return
     */
    public static String doPostWithFile(String url,String savefileName,String fileName) {
        String result = "";
        try {
            // 换行符
    ...
    public static void main(String[] args) {
        String url = "http://phlos.cn:8082/uploadFile";
        String saveFileName = "D:\\test\\das.txt";
        String fileName = "aaa.txt";
        doPostWithFile(url,saveFileName,fileName);
    }
